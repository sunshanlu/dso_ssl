...
std::string TEST_IMG_PATH[17] = {"./tests/res/00000.jpg", "./tests/res/00001.jpg", "./tests/res/00002.jpg", "./tests/res/00003.jpg",
                                 "./tests/res/00004.jpg", "./tests/res/00005.jpg", "./tests/res/00006.jpg", "./tests/res/00007.jpg",
                                 "./tests/res/00008.jpg", "./tests/res/00009.jpg", "./tests/res/00010.jpg", "./tests/res/00011.jpg",
                                 "./tests/res/00012.jpg", "./tests/res/00013.jpg", "./tests/res/00014.jpg", "./tests/res/00015.jpg",
                                 "./tests/res/00016.jpg"};
...
int main(int argc, char **argv)
{
  ...
  for (idx = 0; idx < 17; ++idx)
  {
    ...
    auto frame = std::make_shared<Frame>(frame_config, undistorted_image, only_pixel_undistorted_image, timestamps[idx], exposure_times[idx]);
    ...
    if (initialized)
    {
      tracker->TrackActivateFrame(frame);
      tracker->IsNeedKeyFrame();
    }
  }
